...
<c:import url="../common/header.jsp"/>
	<div id="container" style="background:white; border: 2px solid black; padding:5%" >
		...
		<br /><br />
			<form action="${pageContext.request.contextPath}/admin/customerService/faqFormEnd.do" method="post" onsubmit="return validate();">
				<select name="qtypeno" class="btn thema" style="color : black;">
				...
				<br /><br /><br />
				<input type="text" class="form-control" style="width:100%" placeholder="제목" name="ftitle" id="fTitle" required>
				<br />
			    <textarea class="form-control" style="height:300px; width:100%" name="fcontents" placeholder="내용" required></textarea>
				<br />
