...
public class CommunityController {
	...
	@RequestMapping("/community/selectCommunityList.do")
	public String selectCommunityList(@RequestParam(value="cPage", required=false, defaultValue="1") int cPage, Model model) {
